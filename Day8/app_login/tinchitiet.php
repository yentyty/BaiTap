...
switch ($action) {
  case 'laytinmoi':
    $tintucmoi = tintucDB::get_tintucmoi(addslashes(0),addslashes(5));
    break;
  case 'theoloaitin':
    ...
    case 'chitiet':
     ...
     $tintucmoi = tintucDB::gettintucbyid($idtintuc);
      break;
  default:
    # code...
    break;
...
<div class="w3-main" style="margin-left:250px; ">
    ...
    <div class="w3-row w3-padding-64">
      <div class="w3-twothird w3-container">
        <a href="tinchitiet.php?action=chitiet&idtintuc=<?php echo $tintucmoi->getidtintuc(); ?>"><h1 class="w3-text-teal"><?php echo $tintucmoi-> gettieude(); ?></h1></a>
        <p><?php echo $tintucmoi -> gettomtat(); ?></p>
        <p><?php echo $tintucmoi -> getnoidung(); ?></p>
      </div>
