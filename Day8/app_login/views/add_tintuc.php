...
<html lang="en">
	...
	<body>
		<form action="" method="POST" role="form" enctype="multipart/form-data">
			...
			<select name="userid" id="inputIdloaitin" class="form-control" required="required">
				<?php foreach ($userID as $key => $value): ?>
					<option value="<?php echo $value->getuserid(); ?>"><?php echo $value->getuserid(); ?></option>
				<?php endforeach ?>
			</select>
			<div class="form-group">
			...
			<br>
			<button type="submit" class="btn btn-primary" name="action" value="save_tintuc">Save</button>
